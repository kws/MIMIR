...
/**
 * Configuration class for RTP timing parameters.
 * Allows fine-tuning of timing behavior for different network conditions and requirements.
 */
public class RTPTimingConfig {
    ...
    // Getters
    public long getJitterWarningThresholdMs() { return jitterWarningThresholdMs; }
    public long getJitterErrorThresholdMs() { return jitterErrorThresholdMs; }
    public int getAdaptiveBufferSize() { return adaptiveBufferSize; }
    public boolean isAdaptiveModeEnabled() { return enableAdaptiveMode; }
    public int getRtpThreadPriority() { return rtpThreadPriority; }
    public boolean isUseDedicatedThread() { return useDedicatedThread; }
    public boolean isTimingMetricsEnabled() { return enableTimingMetrics; }
    public long getMetricsReportingIntervalMs() { return metricsReportingIntervalMs; }
    ...
    public static class Builder {
        ...
        public Builder rtpThreadPriority(int priority) {
            this.rtpThreadPriority = Math.max(Thread.MIN_PRIORITY, 
    ...
    public String toString() {
        return String.format("RTPTimingConfig{" +
                ...
                jitterWarningThresholdMs, jitterErrorThresholdMs,
                adaptiveBufferSize, enableAdaptiveMode,
                rtpThreadPriority, useDedicatedThread,
                enableTimingMetrics, metricsReportingIntervalMs);
    }
} 