...
/**
 * In our Websocket <-> RTP pipeline, we need to split our websocket originated TCP packets into RTP packets, and send these 
 * at a fixed rate of 160 bytes every 20ms. 
 * 
 * We handle that by appending audio to an audio buffer, and then creating RTP packets from the audio buffer.
 */
