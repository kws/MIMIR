...
/**
 * Enhanced RTP session with adaptive timing and performance monitoring.
 * Extends the basic RTPSession with jitter detection and adaptive buffering.
 */
public class AdaptiveRTPSession extends RTPSession {
    ...
    public static class TimingMetrics {
        ...
        private TimingMetrics(long sampleCount, double averageInterval, double averageJitter, long maxJitter) {
        ...
        public String toString() {
            return String.format("TimingMetrics{samples=%d, avgInterval=%.2fms, avgJitter=%.2fms, maxJitter=%dms}",
